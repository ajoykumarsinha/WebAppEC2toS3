...
<!-- Theme color -->
<link id="switcher" href="assets/css/materialize.min.css"
	rel="stylesheet">

<!-- Theme color -->
<link id="switcher" href="assets/css/ghpages-materialize.css"
	rel="stylesheet">
...
<body>
				...
				<form class="col s12" id ="uploadForm" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="file-field input-field">
							<div class="btn">
								<span>ADD Image</span> <input type="file" name="userPhoto" id="userPhoto">
							</div>
	...
	var formattedUrl = 'http://'+window.location.hostname+':'+window.location.port+'/WebAppEC2toS3/uploadFile';
	
	console.log(" formattedUrl is "+formattedUrl);
	
	$('button#uploadimage').click( function() {
		
		alert(" Uploading image intp s3 bucket  !!");
	    ...
	    $.ajax({
	        ...
	        success: function(data) {
	        	...
	        	console.log(" Output value is "+data);
	        	$('#status').html(data);
